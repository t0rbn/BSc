...
TODO mehr allgemeines zu markov / Matrix
...
A usable tradeoff is to store all known items together with a list of all other items the former hast been searched together with and the count of times this has happened before.
