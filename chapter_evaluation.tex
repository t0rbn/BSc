...
\centering
  \begin{tabular}{l||c|c|c|c}
		...
		\hline
		Alice   & 3, 3   & 2, 3  & 0, 1.00   & 2, 2 \\
		Bob     & 2, 1.00   & 3, 0  & 2, 0   & 3, 3 \\
		Charlie & 1, 3   & 0, 2  & 1, 2   & 2, 3 \\
		Donald  & 1, 2   & 2, 1.00  & 1, 2   & 2, 1.00 \\
		Erika   & 1, 0   & 0, 1.00  & 3, 2   & 3, 1.00 \\
  \end{tabular}
...
Test Record & 1.00  & 2  & 3  & 4  & 5  & - & Mean & $f$ \\
\hline
Alice       & 0  & 0  & 0  & 15 & 26 & 0 & 4.63 & 0.91 \\
Bob         & 5  & 26 & 9  & 1.00  & 0  & 0 & 2.15 & 0.29 \\
Charlie     & 1.00  & 14 & 23 & 3  & 0  & 0 & 2.68 & 0.42 \\
Donald      & 0  & 10 & 27 & 3  & 0  & 1.00 & 2.83 & 0.44 \\
...
Factor & 1.00  & 2  & 3  & 4  & 5  & - & Mean \\
\hline
Avgerage Skill Level in Searched Items & 1.00 & 3 & 10 & 16 & 11 & 0 & 3.80\\
Avgerage Will Level in Searched Items & 0 & 1.00 & 8 & 16 & 16 & 0 & 4.15\\
Specialization in Searched Items (Skill Levels) & 3 & 5 & 17 & 12 & 4 & 0 & 3.22\\
Specialization in Searched Items (Will Levels) & 1.00 & 0 & 11 & 22 & 5 & 2 & 3.77\\
\end{tabular}
...
estimations using a two-tailed heteroscedastic T-Test with a significance level of 0.05 in order to show if the persons' estimations deviate significantly from the results calculated using the algorithm. Table \ref{tab:survey_ttest} lists the algorithm's result $f_a$, the average fitness score $f_s$ estimated by the test subjects, the standard deviation in the collected data, and the values of the T-Test for each test row. As shown, there is a significant difference between the algorithm's result and the subjects' estimations for the test record \textit{Charlie}. For the other four records, however, the algorithm's results do not deviate significantly from the values collected in the survey.

\begin{table}[H]
\centering
\begin{tabular}{l||c||c|c||c|c}
Test Record & $f_a$ & $f_s$ & Standard Dev. & $p$ & $p \ge 0.05$\\
\hline
Alice       & 0.82 & 0.91 & 0.12 & 0.0000358436701 & No\\
Bob         & 0.45 & 0.29 & 0.16 & 0.0000001306616949 & No\\
Charlie     & 0.47 & 0.42 & 0.16 & 0.05912471945 & Yes\\
Donald      & 0.5  & 0.44 & 0.17 & 0.03119080301 & No\\
...
The weighting parameters generated from the survey data are all in the order of 25\%; in fact, setting all parameters to 0.25 will not cause any significant change in the algorithms error rate\footnote{It would reduce the average difference between the algorithm and the test subjects' estimations from 9.46\% to 9.43\% and the maximum error from 11.07\% to 10.7\%.}, but it will result in all factors being considered equally important and thus reduce the algorithm's complexity.
