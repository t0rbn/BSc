...
% ---------------------------------------------------------------------
\documentclass[11pt,DIV=15,BCOR=20mm,bibliography=totoc,english]{scrbook}
...
\include{chapter_relatedwork}
\include{chapter_objectives}
\include{chapter_concept}
\include{chapter_implementation}
\include{chapter_evaluation}
\include{chapter_discussion_outlook}
