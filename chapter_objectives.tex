...
\subsection{Collecting the Requirements}
As shown in \ref{usecases}, the application is supposed to provide help for two target audiences: project managers staffing their teams and employees looking for help with a certain problem. Semi structured interviews have been conducted in order to collect the end users' wishes and expectations towards the application and to define requirements resulting thereof. In addition to solely gathering the asked persons' general anticipations, the interviews aimed to give answers to these concrete questions:
\begin{itemize}
