...
In order to extract all information from the interviewees' answers, audio recordings have been taped during the interviews; transcipts of those recordings can be found in TODO verweis auf Appendix.
...
TODO schreiben, warum Auslastung nicht erfasst, und deswegen auch nicht im Interview.
