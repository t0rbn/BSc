...
The interviews consist of a ten-minutes-long\footnote{The actual timeframe may vary depending on the 	exhaustiveness of the interviewees' answers.} open discussion between the interviewer and the interviewees, so that if the interviewee gives an extraordinate answer brings up a new idea, the interviewer may ask the interviewee to give further explanations. The questions listed in \ref{interviewquestions} will provide a guideline to structure the interviews. Before the interview, the interviewees have been informed about the procedure, the personal data that will be collected for the interview and the purpose of its collection, and have to give their written consent (see \ref{consentform}).
...
\subsection{Maintenance of The Saved Data}
...
Based on the Flow Team's demands and the data collected in the survey, requirements for to application have been composed. The functional requirements describe features which will be provided by the system, whereas non-functional requirements define framework conditions for its performance.
