...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.88\textwidth,page=1]{images/statement_br.pdf}
    \caption[Statement of the Works Council]{Statement of the Works Council regarding mutual ratings (Page 1)}
\end{figure}
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.88\textwidth,page=2]{images/statement_br.pdf}
    \caption[Statement of the Works Council]{Statement of the Works Council regarding mutual ratings (Page 2)}
\end{figure}
...
\label{transcripts}
The interviews described in \ref{interviewquestions} have been recorded and transcribed. The transcripts can be found in this section.
